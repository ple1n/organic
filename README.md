...
- Anxiety
    - Pregabalin. The optimal treatment for anxiety. Tolerance does not develop. Dose can be maintained at 300mg per day. For the first few months there are some flips in bodily reaction to the drug, during which you may experience drunkeness, stimulation, sedation. The biochemical state stabilizes after 6 months.
...
- Sleep induction, which causes sleepiness but does not make you _want to_ sleep
    1. Trazodone. Has good half-life parameter, which makes you not sleepy in the day. Start from 25mg. Dose not cause the very annoying mouth/throat dryness like other anti-cholinergics
...
- Wound treatment
    - Scar can be prevented by applying _Verteporfin_ solution (use concentration at least 1000 fold higher than IC50) immedaitely after injury.
    - Apply [4-Butylresorcinol](https://en.wikipedia.org/wiki/4-Butylresorcinol) frequently to prevent post-wounding darkening of skin.
...
- Headache
    ...
    - Acetaminophen, 0.6g to 0.9g. It acts centrally, which minimizes the needless effects in other areas.
- Pain from inflammation, such as wounds.
...
## The un-justified fear of drugs
